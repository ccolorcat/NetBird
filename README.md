...
dependencies {
    ...
    implementation 'com.github.ccolorcat.NetBird:netbird-logging-support:v4.3.4'
    implementation 'com.github.ccolorcat.NetBird:netbird-cache-support:v4.3.4'
    implementation 'com.github.ccolorcat.NetBird:netbird-gson-parser:v4.3.4'
    implementation 'com.github.ccolorcat.NetBird:netbird-jackson-parser:v4.3.4'
    implementation 'com.github.ccolorcat.NetBird:netbird-fastjson-parser:v4.3.4'
}
```
...
> 1. LoggingTailInterceptor 添加格式化响应内容的支持。
